...
public class AirportRepository {
    ...
    public int countOfBookingsDoneByPassengerAllCombined(Integer passengerId) {
        ...
        for (Integer flightId : flightPassengerMap.keySet()){
            ...
            for(Integer pId : passengerList){
                if(Objects.equals(pId, passengerId)){
                    count++;
                }
            }
        }
    ...
    public Airport getAirportByName(String airportName) {
        return airportMap.getOrDefault(airportName, null);
    }
    ...
    public String cancelATicket(Integer flightId, Integer passengerId) {
        ...
        int n = pIds.size();
        for(int i = 0 ; i < n ; i++ ){
            if(Objects.equals(pIds.get(i), passengerId)){
                newList.add(i);
            }
        }
        for (int idx : newList) {
    ...
    public int getCancelBookings(Integer flightId) {
        //  return 1;
        return flightCancelMap.getOrDefault(flightId, 1);
    }
}
